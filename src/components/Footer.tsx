...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-black px-6 py-8 md:px-12 xl:px-page-px">
      <div className="mx-auto flex max-w-content-max flex-col items-center gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col items-center gap-4 md:flex-row md:gap-6">
          <span className="font-pixbob-lite text-sm text-text md:text-base">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              aria-label="LinkedIn"
              className="flex min-h-[44px] min-w-[44px] items-center justify-center text-text"
            >
